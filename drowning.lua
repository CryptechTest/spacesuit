...
local function check_player(player, timer)
	...
	local has_helmet = armor_inv:contains_item("armor", "spacesuit:helmet_base") 
	...
	local has_chestplate = armor_inv:contains_item("armor", "spacesuit:chestplate_base")
		or armor_inv:contains_item("armor", "ctg_spacesuit:chestplate_gold")
		or armor_inv:contains_item("armor", "ctg_spacesuit:chestplate_titanium")
		or armor_inv:contains_item("armor", "spacesuit:chestplate")
	local has_pants = armor_inv:contains_item("armor", "spacesuit:pants_base")
	 	or armor_inv:contains_item("armor", "ctg_spacesuit:pants_gold")
	 	or armor_inv:contains_item("armor", "ctg_spacesuit:pants_titanium")
		or armor_inv:contains_item("armor", "spacesuit:pants")
	local has_boots = armor_inv:contains_item("armor", "spacesuit:boots_base")
		or armor_inv:contains_item("armor", "ctg_spacesuit:boots_gold")
		or armor_inv:contains_item("armor", "ctg_spacesuit:boots_titanium")
		or armor_inv:contains_item("armor", "spacesuit:boots")
